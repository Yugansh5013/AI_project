# CEC 2017 Benchmark Runner
# Run on TEAMMATE's machine: python run_cec2017.py
import sys, os, time
...
POP_SIZE = 30
DIM = 10
OUTPUT = "cec2017_results.csv"

ALL_ALGOS = {"A-POA": run_apoa, "Base-POA": run_base_poa}
ALL_ALGOS.update(ALGORITHMS)

# Build CEC 2017 functions (F1, F3-F29)
from opfunu.cec_based import cec2017
cec_funcs = {}
for i in [1] + list(range(3, 30)):
    cls = getattr(cec2017, f"F{i}2017", None)
    if cls:
        cec_funcs[f"CEC2017_F{i}"] = cls
